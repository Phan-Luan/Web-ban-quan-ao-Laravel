                    ...
                    <div class="e-navlist e-navlist--active-bg">
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link px-2 active"
                                    ...
                                    <i class="fa fa-fw fa-bar-chart mr-1"></i><span>My Profile</span></a>
                            </li>
                        </ul>
                    </div>
                    <div class="e-navlist e-navlist--active-bg">
                        <ul class="nav">
                            <li class="nav-item"><a class="nav-link px-2 active"
                                    ...
                                    <i class="fa fa-fw fa-bar-chart mr-1"></i><span>My Order</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                        ...
                                        <div class="col-12 col-sm-auto mb-3">
                                            <div class="mx-auto" style="width: 140px;">
                                                <div class="d-flex justify-content-center align-items-center rounded"
                                                    ...
                                                    <img src="{{ asset('storage/images/admin/product/' . $user->image) }}"
                                                        alt="avatar">
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="number"
                                                                        name="phone" placeholder="0965433333"
